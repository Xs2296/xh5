		...
		<view class="uni-date-editor" @click="show">
			<slot>
				<view class="uni-date-editor--x" :class="{ 'uni-date-editor--x__disabled': disabled, 'uni-date-x--border': border }">
					...
					<view v-if="showClearIcon" class="uni-date__icon-clear" @click.stop="clear"><uni-icons type="clear" color="#c0c4cc" size="22"></uni-icons></view>
				</view>
			</slot>
		</view>
			...
			<view v-else class="uni-date-range--x" :style="pickerPositionStyle">
				...
				<view v-if="hasTime" class="popup-x-header uni-date-changed">
					...
					<view class="popup-x-header--datetime">
						...
						<time-picker type="time" v-model="tempRange.endTime" :end="timepickerEndTime" :border="false" :disabled="!tempRange.endDate" :hideSecond="hideSecond">
							<input
								class="uni-date__input uni-date-range__input"
								type="text"
