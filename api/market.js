...
class Market {
    ...
    static getMarketExchange(data) {
        return Serve.get(`/market/exchange`, data)
    }

    static getMarketContract(data) {
        return Serve.get(`/market/contract`, data)
    }

    static getMarketKline(data) {
        return Serve.get(`/market/kline`, data)
    }
