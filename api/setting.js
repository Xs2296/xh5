...
class Setting {
	...
	static disableSmsEmailGoogle(data, {
		...
		return Serve.post(`/user/disableSmsEmailGoogle`, data, {
			btn
		});
	}
	/**
	...
	static enableSmsEmailGoogle(data, {
		...
		return Serve.post(`/user/enableSmsEmailGoogle`, data, {
			btn
		});
	}
	/**
	...
	static setOrResetPaypwd(data) {
		return Serve.post(`/security/payPwd`, data);
	}
	/**
	 * 设置或重置登录密码
	 * @param {object} data
	...
	static updatePassword(data, {
		...
		return Serve.post(`/security/password`, data, {
			btn
		});
	}
	/**
	...
	static bindEmail(data, {
		...
		return Serve.post(`/security/bindEmail`, data, {
			btn
		});
	}
	...
	static bindPhone(data, {
		...
		return Serve.post(`/security/bindPhone`, data, {
			btn
		});
	}
	...
	static unbindEmail(data) {
		return Serve.post(`/security/unbindEmail`, data);
	}
	...
	static unbindPhone(data) {
		return Serve.post(`/security/unbindPhone`, data);
	}
	...
	static forgetPasswordAttempt(data) {
		return Serve.post(`/login/forget`, data, {
			toast: false
		});
	}
	/**
	...
	static forgetPassword(data, {
		...
		return Serve.post(`/login/setPwd`, data, {
			btn
		});
	}
	...
	static bindGoogleToken(data, {
		...
		return Serve.post(`/user/bindGoogleToken`, data, {
			btn
		});
	}
	/**
